...
@app.route('/')
def home():
    # Esta es la respuesta que recibirá tu despertador externo cada 5 minutos
            ...
            if condicion_compra_ok:
                try:
                    ...
                    if usdt_disponible >= 5.0: 
                        ...
                        peak_maximo = precio_compra_real
                        bot_comprado = True
                        print(f"✅ ¡Compra OK! Tope mínimo: ${tope_minimo_blindado:.4f}")
                except Exception as e:
            ...
            if precio_actual <= tope_minimo_blindado:
                ...
                try:
                    ...
                    if tokens_en_cartera > 0:
                        ...
                        bot_comprado = False
                        print("💀 Posición liquidada. Capital a salvo.")
                except Exception as e:
                ...
                try:
                    ...
                    if tokens_en_cartera > 0:
                        exchange.create_market_sell_order(PAR_TRADING, tokens_en_cartera)
                        bot_comprado = False
                        print("🏆 Ganancias tomadas con éxito.")
                except Exception as e:
...
# Lanzar el cerebro del bot en un hilo separado para que no interfiera con el puerto
...
if __name__ == '__main__':
    # Lee el puerto dinámico que Render le asigna obligatoriamente a los Web Services
